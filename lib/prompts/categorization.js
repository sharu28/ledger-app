...
- Normalize dates to YYYY-MM-DD format where possible (look for a "Date" or date-like column)
- Use the most descriptive text column as the "description" output field
- Use the "_amount" field as the transaction amount (fall back to "amount" or numeric columns if missing)
- Use the "_type" field as debit/credit (fall back to "type" or Dr/Cr columns if missing)
